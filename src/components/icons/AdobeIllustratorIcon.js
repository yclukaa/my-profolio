import classes from "./AdobeIllustratorIcon.module.css";

const AdobeIllustratorIcon = () => {
  return (
    <svg style={{enableBackground: "new 0 0 240 234"}} version="1.1" viewBox="0 0 240 234" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
      <g id="vlpa">
        <g id="vlpb">
          <g id="vlpc">
            <g id="vlpd">
